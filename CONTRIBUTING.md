...
> **Note:** `caveman/SKILL.md`, `plugins/caveman/skills/caveman/SKILL.md`, `.cursor/skills/caveman/SKILL.md`, and `dist/caveman.skill` are auto-synced by CI after merge. Do not edit them directly.
> 
